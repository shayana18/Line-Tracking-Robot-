...
//Serial.println(right2);
  ...
  else if ( left2 < min_lim && left1 < min_lim && mid < min_lim && right1< min_lim && right2 < min_lim && jump != 1){
      maxspeed = 30;
      turn_left();  
      //Serial.print("circle");
  ...
  if(currentmillis - jumptime > 20000 && left2 > min_lim && left1 > min_lim && mid > min_lim && right1 > min_lim && right2 > min_lim){
    jump++;
